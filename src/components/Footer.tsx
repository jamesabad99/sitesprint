...
export default function Footer() {
  return (
    <footer className="relative px-4 pb-10 pt-14 md:px-6">
      {/* Divider top */}
      <div
      ...
      <div className="mx-auto flex max-w-[600px] flex-col items-center text-center">
        ...
        <p className="mt-2 text-[13px] text-white/40">
          Tu web profesional en 48 horas.
        </p>
        ...
        <a
          ...
          className="mt-6 inline-flex items-center gap-2 rounded-full border border-white/10 px-5 py-2 text-[13px] font-medium text-white/60 transition-all duration-200 hover:border-white/20 hover:text-white/80"
        >
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
        ...
        <p className="mt-8 text-[12px] text-white/25">
          &copy; {new Date().getFullYear()} SiteSprint. Todos los derechos
          reservados.
        </p>
      </div>
    </footer>
