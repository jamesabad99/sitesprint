...
export default function FinalCTA() {
  return (
    <section data-animate className="px-5 py-16 md:px-8 md:py-20">
      <div data-animate-child className="relative mx-auto w-full max-w-[900px] overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 text-center sm:p-10 md:p-14">
        ...
        <p className="mx-auto mt-3 max-w-[400px] text-[15px] leading-relaxed text-slate-500">
          Web express en 48 horas o proyecto completamente a medida.
        </p>
        ...
        <a
          ...
          className="mt-6 inline-flex items-center gap-2.5 rounded-full bg-slate-900 px-7 py-3 text-sm font-semibold text-white transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-lg"
        >
